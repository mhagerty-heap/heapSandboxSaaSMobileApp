...
class MainActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    R.id.login_button.onClickDebounced {
      MaterialDialog(this).show {
        title(R.string.enterEmailPrompt)
        message(R.string.enterEmailMessage)
        input(
          hint = "Enter Email Address",
          prefill = "mobiletest@test.com",
        ...
        negativeButton(R.string.cancelMessage)
        positiveButton(R.string.loginMessage)
